          ...
          <section className="support__page">
               <div className="page-container">
                 ...
                 {/*<h2> How Can We Assist You Today?</h2>*/}
                    ...
                    <p>Make sure you have a stable internet connection.If the problem persists, please contact our support team.</p>
                    <h3>If you still have questions or need additional assistance, don't hesitate to contact us. We are always ready to help you!🖐🖐🖐</h3>
               </div>
          </section>
     );
};
