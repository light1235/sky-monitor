...
const ListingCard = ({ item, wish,ind,setWish}) => {
     ...
     const VoteMenu = (
          <div className="vote__menu">
               <div className="vote-item item-yes">
                    <animated.svg  onClick={handleClick} width="30" height="auto" fill={colorYes ? 'none' : '#8bc643'} style={{  ...springsYes}} viewBox="0 0 16 15"  xmlns="http://www.w3.org/2000/svg">
                         <path
               ...
               <div className="vote-item item-no">
                    <animated.svg onClick={handleClickNo} width="30" height="auto" viewBox="0 0 16 15" fill={colorNo ? 'none' : '#CC0000'} style={{  ...springsNo}} xmlns="http://www.w3.org/2000/svg">
                         <path
