...
const ArticlePage = ({post}) => {
     const comments = [
          {id:1,name:'Roy Jamson',date:'18.05.2024',context:'11Rewline\'s team of experts is committed to helping traders make informed trading decisions by utilizing the power of artificial intelligence. Using artificial intelligence-based algorithms, the company provides traders with insights'},
