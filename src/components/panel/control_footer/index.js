          ...
          <div className="control-menu">
               ...
               <div className="main-menu">
                    ...
                    <ul>
                         ...
                         <li className={pathname === '/panel/vote' ? 'active-menu' : ''}><Link href='/panel/vote'><i
                              className="icon-thumbs-up-alt"></i>Vote</Link></li>
                         <li className={pathname === '/panel/sale-statistics' ? 'active-menu' : ''}><Link
                              href='/panel/sale-statistics'><i className="icon-sale"></i>Sale statistics</Link></li>
                         <li className={pathname === '/panel/alerts' ? 'active-menu' : ''}><Link href='/panel/alerts'><i
                              className="icon-warning"></i>Alerts</Link></li>
                         <li className={pathname === '/panel/timeline-adv' ? 'active-menu' : ''}><Link
                              href='/panel/timeline-adv'><i className="icon-time-line"></i>Timeline advertise</Link>
                         </li>
                         ...
                         <li className={pathname === '/panel/user-lvl' ? 'active-menu' : ''}><Link
                              href='/panel/user-lvl'><i className="icon-user-1"></i>User Level</Link></li>
                         <li className={pathname === '/panel/payment-settings' ? 'active-menu' : ''}><Link
                              href='/panel/payment-settings'><i className="icon-payments"></i>Payment settings</Link>
                         </li>
                         <li className={pathname === '/panel/insurance' ? 'active-menu' : ''}><Link
                              href='/panel/insurance'><i className="icon-shield-alt"></i>Insurance</Link>
                         </li>
                    </ul>
               </div>
          </div>
